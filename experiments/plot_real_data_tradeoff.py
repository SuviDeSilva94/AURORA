"""
Real-data (AI4I 2020) safety/resolution Pareto plot.

Mirrors ``plot_tradeoff_pareto.py`` (CCTV) and ``plot_motor_tradeoff.py``
(motor) for the third workload, allowing side-by-side reading of the
dual-gate's behaviour across one real and two synthetic fault
distributions.
"""
...
AGENTS = {
    "Rule-Based": "real_rule_based_results.json",
    "AIF (No Gate)": "real_aif_no_gate_results.json",
    "AURORA": "real_aurora_results.json",
}
...
def main():
    ...
    ax.set_title("Real industrial data (AI4I 2020)", fontsize=14, pad=8)

    ax.legend(loc="lower right", frameon=True, framealpha=0.95)

    fig.tight_layout()
    out = RESULTS_DIR / "real_data_tradeoff_pareto.pdf"
    ...
    summary_path = RESULTS_DIR / "real_data_tradeoff_pareto_points.json"
